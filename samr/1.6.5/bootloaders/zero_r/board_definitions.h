...
#define BOARD_VSEL2_PORT					(1)
#define BOARD_VSEL2_PIN						(22)

#define BOARD_VSEL3_PORT					(1)
#define BOARD_VSEL3_PIN						(2)

#define BOARD_VSEL4_PORT					(1)
#define BOARD_VSEL4_PIN						(23)

#define BOARD_CTRL_PORT						(1)
#define BOARD_CTRL_PIN						(3)
